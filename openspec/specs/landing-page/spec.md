...
Defines the content, structure, link obligations, and visual treatment of the single-page personal landing site served at `https://mugdha.dev`. The capability exists to (a) present a minimal, typography-forward introduction to Mugdha Adhav and (b) carry a prominent, indexable, followable backlink to `whatifed.com` — the primary SEO purpose of the site.
